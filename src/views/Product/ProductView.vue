    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="container px-6 py-10 mx-auto">
        <ul class="flex flex-wrap w-full lg:w-1/2 mx-auto justify-around">
          <li v-for="e in month" :key="e" class="basis-1/6  text-center cursor-pointer text-lg" @click="selectMonth = e"><span class="px-8 py-0.5" :class="selectMonth === e && 'bg-vege-400 rounded-full text-white'">{{ e }}</span></li>
        </ul>
