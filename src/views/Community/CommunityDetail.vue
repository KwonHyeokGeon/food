<template>
  <div class="basis-full">
      ...
      <div class="flex justify-between">
          <div>
              <router-link to="/community/list" class="bg-indigo-400 hover:bg-indigo-600">목록으로</router-link>
          </div>
          <div class="flex gap-x-5">
              <router-link to="/community/modify" class="bg-indigo-400 hover:bg-indigo-600">수정</router-link>
